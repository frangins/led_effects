# Contributing to led_effects

led_effects is written in [Rust](https://www.rust-lang.org/).
...
2. Clone your fork to a local repository:
        ...
        $ git clone https://github.com/you/led_effects.git
        $ cd led_effects

3. Add the main repository as a remote:

        $ git remote add upstream https://github.com/frangins/led_effects.git
